...
const WritePage = () => {
  ...
  const uploadNews = async (e) => {
    e.preventDefault();
    const options = {
      url: "https://newsapplicationbackend-1.onrender.com/api/v1/news/admin/uploads-news",
      method: "POST",
      formData,
  ...
  return (
    <div className="p-[4rem] bg-[#6b6b746a] flex flex-col gap-[4rem]  items-center w-full ">
      ...
      <form
        ...
        action="https://newsapplicationbackend-1.onrender.com/api/v1/news/admin/uploads-news"
        onSubmit={uploadNews}
